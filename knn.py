...
z = zipfile.ZipFile(r'C:\Users\Ganapriya\Documents\AppliedProject\Kaggle\SF_Crime\train.csv.zip')
...
# Submit for K=40
z = zipfile.ZipFile(r'C:\Users\Ganapriya\Documents\AppliedProject\Kaggle\SF_Crime/test.csv.zip')
